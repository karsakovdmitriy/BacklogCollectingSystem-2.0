              ...
              <div key={group.id} className="border border-[#30363d] rounded-xl bg-[#0d1117]/40 overflow-hidden shadow-sm">
                ...
                {!isCollapsed && (
                  <div className="p-4 space-y-3 bg-[#0d1117]/20">
                    ...
                    {/* DND Convert request to feature field inside group */}
                    <div
                      ...
                      className="p-3 border-2 border-dashed border-[#30363d]/60 rounded-xl text-center text-[#8b949e] hover:border-[#58a6ff] hover:text-white hover:bg-[#161b22]/40 transition-all text-xs cursor-pointer flex items-center justify-center gap-2 py-4"
                    >
                      <span>✨ Преобразовать в фичу (Перетащите реквест сюда)</span>
                    </div>
                  </div>
                )}
              </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-3 space-y-3 overflow-y-auto flex-1 bg-[#0d1117]/20 scrollbar-thin">
                    ...
                    {/* DND Convert request to feature field inside Dashboard column */}
                    <div
                      onDragOver={(e) => e.preventDefault()}
                      onDrop={(e) => {
                        e.preventDefault();
                      ...
                      className="p-3 border-2 border-dashed border-[#30363d]/60 rounded-xl text-center text-[#8b949e] hover:border-[#58a6ff] hover:text-white hover:bg-[#161b22]/40 transition-all text-xs cursor-pointer flex items-center justify-center gap-2 py-3"
                    >
