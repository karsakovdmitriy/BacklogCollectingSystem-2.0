      ...
      <div className="flex flex-wrap items-center justify-between gap-4 bg-[#161b22] p-4 rounded-xl border border-[#30363d]">
        <div className="space-y-1">
          ...
          <p className="text-xs text-[#8b949e]">
            Панель первичного сбора требований. Влияние на классификацию: статус (Принят, Отклонен, В проработку) можно назначить только при заполнении всех 7 обязательных атрибутов (без привязки к Эпику и Фиче).
          </p>
        </div>
